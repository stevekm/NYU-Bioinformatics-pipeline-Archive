...
# this script will parse Tophat stats sheet to get numbers of reads
...
# $2 /path/to/output_dir # temporary for Giselle.. 
...
# because I cannot write to Aris' Giselle proj dir
