...
# EXMPLE:
# ~/pipeline-master/code/scripts-copy-chipseq.sh ~/projects/ColumbiaU-Jinsook-2015-10-22/ /ifs/data/sequence/results/external/columbia/2015-10-22/chip-seq/
...
####
#####
###### !! This is a custom version of the script for ColumbiaU-Jinsook-2015-10-22/chipseq-analysis !! 
####
###
