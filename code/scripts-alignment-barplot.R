...
# 
# > ReadsTable
# Total.Reads Aligned.Reads Deduplicated.alignments
# Sample1    43743601      33114731                32004798
# Sample2    37888317      28309937                26982520
# Sample3    44664124      34478776                29728794
# Sample4    39804330      30168289                28707723
# Sample5    36708833      27943991                26717704
# Sample6    49666749      33808528                25559735
# Sample7    47457349      33249888                22385229
# Sample8    48866465      37155596                34029149
# -------

# get the reads.tsv from the script call
ReadsTable<-read.table(file = args[6],header = T,sep = "\t")
...
# OutFile_name<-paste0(dirname(args[6]),"_read_barplots.pdf")
# OutFile_path<-paste0(args[7],"/",OutFile_name)
# 
# # write a PDF version
# pdf(file = OutFile_path,width = 8,height = 8)
# layout(Raw_Reads_Matrix_matrix)
# par(mar=c(0,0,4,0))
# plot(1,type='n',axes=FALSE,xlab="",ylab="",main = "Sequencing Reads",cex.main=2)
# legend("bottom",legend=c("Deduplicated","Duplicated","Unaligned"),fill=BARPLOT_COLORS,bty = "n",ncol=length(BARPLOT_COLORS),cex=1.0)
